...
export default function NotificationBell() {
  ...
  function navUrl(n: Notification) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          ref={panelRef}
          className="absolute right-0 top-full z-50 mt-2 w-80 max-h-[70vh] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl"
        >
              ...
              notifications.map((n) => {
                ...
                return (
                  <Wrapper
                    ...
                    className={`flex gap-3 border-b border-slate-50 px-4 py-3 transition-colors ${
                      url ? "cursor-pointer hover:bg-slate-50" : ""
                    } ${!n.read ? "bg-sky-50/50" : ""}`}
                  >
